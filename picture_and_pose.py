...
# Assuming realsense.py is in a 'tools' directory or otherwise accessible
from tools.realsense import RealSense

def collect_data(output_dir, calibration_dir, robot_ip="10.0.0.78"):
    """
    Collects RGBD images from a RealSense camera along with the calculated
    camera-to-base pose from a UR robot.
    """
    # --- Initialization ---
    print("Initializing...")
